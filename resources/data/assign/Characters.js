...
PSDE.setCharacterCurrentRoom(al, "alApartmentBedroom");
al.setPhilautia(75);
al.setAgape(50);
...
PSDE.setCharacterCurrentRoom(avo, "avoApartmentBedroomAvo");
avo.setPhilautia(50);
avo.setAgape(75);
...
PSDE.setCharacterCurrentRoom(betty, "alBuildingFirstFloorHallwayA");
...
PSDE.setCharacterCurrentRoom(charlie, "remmyApartmentLivingroom");
...
PSDE.setCharacterCurrentRoom("martina", "chartyApartmentBedroomMarty");
PSDE.getCharacterByID("martina").setAttributes(8,10,10,17,14,15).setLevel(7).setImage("resources/images/characters/Martina.svg").addSexWith("ozzy", true).addDated("ozzy", 1);
PSDE.setCharacterCurrentRoom("marty", "chartyApartmentBedroomMarty");
PSDE.getCharacterByID("marty").setAttributes(10,12,10,17,15,10).setLevel(7).setImage("resources/images/characters/Marty.svg");
...
PSDE.setCharacterCurrentRoom(ozzy, "ozzyApartmentBathroom");
...
PSDE.setCharacterCurrentRoom(pandora, "pandorasBoxBasementHiddenBedroom");
...
PSDE.setCharacterCurrentRoom(remmy, "remmyApartmentBedroom");
...
PSDE.setCharacterCurrentRoom("tellerMicely", "zootopiaCreditUnion44thEntrance");
PSDE.getCharacterByID("tellerMicely").setImage("resources/images/characters/tellerMicely.png").addPreferredSpecies("stoat");

velvet.setAttributes(10,15,11,15,15,14);
velvet.setLevel(10);
velvet.setImage("resources/images/characters/Velvet.png");
velvet.setEyeColour("brown");
PSDE.setCharacterCurrentRoom(velvet, "alApartmentBedroom");
...
PSDE.setCharacterCurrentRoom("weaver", "weaverApartmentLivingroom");
weaver.setImage("resources/images/characters/RedWeaver.png").setEyeColour("red");
...
PSDE.setCharacterCurrentRoom("cottonHopps", "limbo");
PSDE.getCharacterByID("cottonHopps").setAttributes(10,10,10,10,10,10).setLevel(1).setImage("resources/images/characters/Cotton.png").addPreferredSpecies("fox").addPreferredSpecies("rabbit").addBiologicalParent("stuHopps").addBiologicalParent("bonnieHopps");
PSDE.setCharacterCurrentRoom("judyHopps", "limbo");
PSDE.getCharacterByID("judyHopps").setAttributes(16,16,13,15,14,12).setLevel(13).addPreferredSpecies("fox").addPreferredSpecies("rabbit").addSexWith("nickWilde").addFiance("nickWilde").addDating("nickWilde").addBiologicalParent("stuHopps").addBiologicalParent("bonnieHopps");
PSDE.setCharacterCurrentRoom("violetHopps", "limbo");
PSDE.getCharacterByID("violetHopps").setAttributes(10,12,16,17,16,15).setLevel(13).addPreferredSpecies("fox").addPreferredSpecies("rabbit").addBiologicalParent("stuHopps").addBiologicalParent("bonnieHopps");
PSDE.setCharacterCurrentRoom("bonnieHopps", "limbo");
PSDE.getCharacterByID("bonnieHopps").setAttributes(15,15,15,17,13,13).setLevel(15).addPreferredSpecies("fox").addPreferredSpecies("rabbit");
PSDE.setCharacterCurrentRoom("stuHopps", "limbo");
PSDE.getCharacterByID("stuHopps").setAttributes(16,15,15,17,12,12).setLevel(14).addPreferredSpecies("fox").addPreferredSpecies("rabbit").addSexWith("bonnieHopps").addSpouse("bonnieHopps").addBiologicalParent("ottoHopps");
PSDE.setCharacterCurrentRoom("rosieReynard", "alBuildingBasementG");
PSDE.getCharacterByID("rosieReynard").setAttributes(6,14,11,11,8,12).setLevel(1).setImage("resources/images/characters/Rosie.png").setEyeColour("lightblue").setFurColour("red","cream").setPhilautia(25).setAgape(50).setDefaultDisposition(0, 25, 25, 0, 15, 0).addPreferredSpecies("fox").addPreferredSpecies("wolf").addBiologicalParent("nickWilde");
PSDE.setCharacterCurrentRoom("nickWilde", "limbo");
PSDE.getCharacterByID("nickWilde").setAttributes(15,16,13,30,30,17).setLevel(20).addPreferredSpecies("fox").addPreferredSpecies("rabbit").addBiologicalParent("vivianWilde").addBiologicalParent("johnWilde");
PSDE.setCharacterCurrentRoom("beckyWilde", "limbo");
PSDE.getCharacterByID("beckyWilde").setAttributes(13,15,11,12,11,11).setLevel(13).addPreferredSpecies("fox").addSexWith("nickWilde").addBiologicalParent("vivianWilde").addBiologicalParent("nickWilde");
PSDE.setCharacterCurrentRoom("johnWilde", "limbo");
PSDE.getCharacterByID("johnWilde").addPreferredSpecies("fox").addSpouse("vivianWilde");
PSDE.setCharacterCurrentRoom("vivianWilde", "limbo");
PSDE.getCharacterByID("vivianWilde").addPreferredSpecies("fox").addSexWith("nickWilde");
