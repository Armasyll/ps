...
charlieBeatingHeart = new Item("charlieBeatingHeart", "Charlie's Heart", "The vixen's still-beating heart thrums at a quick pace. It shifts around unnaturally, and feels as though it's pulling you in a specific direction.");
...
annekePantiesBlue = new Clothing("annekePantiesBlue", "Blue Panties", "A pair of blue, almost see-through panties.", "groin");
...
charliePantiesPink = new Clothing("charliePantiesPink", "Pink Panties", "A pair of pink panties.", "groin");
charliePantsGrey = new Clothing("charliePantsGrey", "Grey Pants", "A pair of grey pants.", "legs");
remmyTanktopWhite = new Clothing("remmyTanktopWhite", "White tank-top", "A white tank-top.", "torso");
remmyCargopantsTan = new Clothing("remmyCargopantsTan", "Tan Cargo Pants", "A pair of tan cargo pants.", "legs");
rosieShirtPatchy = new Clothing("rosieShirtPatchy", "Patchy Shirt", "A torn, patched up cloth shirt.", "torso");
rosiePantsPatchy = new Clothing("rosiePantsPatchy", "Patchy Pants", "A pair of torn, patched up cloth pants.", "legs");

// Keys
masterKey = new Item("masterKey", "Simple Key", "A simple key.");
remmyApartmentLocationKey = new Item("remmyApartmentLocationKey", "Remmy's Apartment Key", "Remmy's Apartment Key");
alBuildingLocationKey = new Item("alBuildingLocationKey", "Skeleton Key", "Skeleton key for Pack Street.");
...
pandorasBoxLocationKey = new Item("pandorasBoxLocationKey", "Key to Pandora's Box", "A complex brass key meant for digitigrade mammals to Pandora's Box.");
