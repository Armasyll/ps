...
new GameEvent("martinaToBathroomEvent", "move", martina, undefined, undefined, undefined, undefined, chartyApartmentBedroomMarty, undefined, "setCharacterPath(martina, chartyApartmentBathroom)", false);
new GameEvent("martinaToBedroomEvent", "move", martina, undefined, undefined, undefined, undefined, chartyApartmentBathroom, undefined, "setCharacterPath(martina, chartyApartmentBedroomMarty)", false);
...
new GameEvent("avoWorkRoutineStartEvent", undefined, undefined, undefined, undefined, undefined, undefined, undefined, new Cron(30, 7, undefined, undefined, "1-5"), "avoWorkRoutineStart('avoWorkRoutineStartEvent')", false);
new GameEvent("avoWorkRoutineStartSitEvent", "move", avo, undefined, undefined, undefined, undefined, pandorasBoxCheckout, undefined, "avoWorkRoutineStartSit('avoWorkRoutineStartSitEvent')", false);
new GameEvent("avoWorkRoutineEndEvent", undefined, undefined, undefined, undefined, undefined, undefined, undefined, new Cron(30, 17, undefined, undefined, "1-5"), "avoWorkRoutineEnd('avoWorkRoutineEndEvent')", false);
...
new GameEvent("charlieHeartbeatRosieRoomEvent", undefined, player, rosie, charlieBeatingHeart, undefined, undefined, rosie.room, undefined, "charlieHeartbeatRosie('charlieHeartbeatRosieRoomEvent')", false);
