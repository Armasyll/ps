...
zootopiaExchangeStreet01 = new Room("zootopiaExchangeStreet01", "zootopiaExchangeStreet", "1 Exchange Street", "street", zootopiaCell, zootopiaExchangeStreetLocation);
...
pandorasBoxFrontA = new Room("pandorasBoxFrontA", "pandorasBoxFront", "Front Aisle", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxFrontB = new Room("pandorasBoxFrontB", "pandorasBoxFront", "Front Aisle", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxFrontC = new Room("pandorasBoxFrontC", "pandorasBoxFront", "Front Aisle", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxBackA = new Room("pandorasBoxBackA", "pandorasBoxBack", "Back Aisle", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxBackB = new Room("pandorasBoxBackB", "pandorasBoxBack", "Back Aisle", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxBackC = new Room("pandorasBoxBackC", "pandorasBoxBack", "Back Aisle", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxAisleA1 = new Room("pandorasBoxAisleA1", "pandorasBoxAisleA", "Aisle A-H", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxAisleA2 = new Room("pandorasBoxAisleA2", "pandorasBoxAisleA", "Aisle A-H", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxAisleA3 = new Room("pandorasBoxAisleA3", "pandorasBoxAisleA", "Aisle A-H", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxAisleB1 = new Room("pandorasBoxAisleB1", "pandorasBoxAisleB", "Aisle I-P", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxAisleB2 = new Room("pandorasBoxAisleB2", "pandorasBoxAisleB", "Aisle I-P", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxAisleB3 = new Room("pandorasBoxAisleB3", "pandorasBoxAisleB", "Aisle I-P", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxAisleC1 = new Room("pandorasBoxAisleC1", "pandorasBoxAisleC", "Aisle Q-Z", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxAisleC2 = new Room("pandorasBoxAisleC2", "pandorasBoxAisleC", "Aisle Q-Z", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
pandorasBoxAisleC3 = new Room("pandorasBoxAisleC3", "pandorasBoxAisleC", "Aisle Q-Z", undefined, pandorasBoxCell, pandorasBoxStorefrontLocation);
